...
class Epos2Printer {
  ...
  Epos2Printer._(this.id, this.series, this.model, this.target)
      : _statusChannel = EventChannel("epson_pos_printer/printer/$id/status");
  ...
  Future<Epos2PrinterStatusInfo> sendData({
    Duration timeout = const Duration(milliseconds: 10000),
      ...
      invokeChannel<Map>(
        ...
        (data) {
          return Epos2PrinterStatusInfo.fromJson(
  ...
  Future<void> addCommand(Uint8List data) async => invokeChannel(
        id: id,
        method: "addCommand",
        arguments: {"data": data},
      );
