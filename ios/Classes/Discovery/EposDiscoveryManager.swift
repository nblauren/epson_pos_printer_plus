...
/// Contract
/// * Channel Name: epson_pos_printer/discovery
...
/// }
/// ```
public class EposDiscoveryManager: NSObject, FlutterStreamHandler {
    @objc
    public static func register(with registrar: FlutterPluginRegistrar) {
        let streamChannel = FlutterEventChannel(name: "epson_pos_printer/discovery",
                                                binaryMessenger: registrar.messenger())

        let instance = EposDiscoveryManager()
